...
public class PegaSQLXML implements SQLXML {

    private String strSQLXML;

    public PegaSQLXML(String strSQLXML) {
        this.strSQLXML = strSQLXML;
    }
    ...
    public InputStream getBinaryStream() throws SQLException {
        return new ByteArrayInputStream(this.strSQLXML.getBytes());
    }
    ...
    public OutputStream setBinaryStream() throws SQLException {
        throw new SQLFeatureNotSupportedException("OutputStream setBinaryStream()");
    }
    ...
    public Reader getCharacterStream() throws SQLException {
        throw new SQLFeatureNotSupportedException("Reader getCharacterStream()");
    }
    ...
    public Writer setCharacterStream() throws SQLException {
        throw new SQLFeatureNotSupportedException("Writer setCharacterStream()");
    }
    ...
    public <T extends Source> T getSource(Class<T> sourceClass) throws SQLException {
        throw new SQLFeatureNotSupportedException("<T extends Source> T getSource(Class<T> sourceClass)");
    }
    ...
    public <T extends Result> T setResult(Class<T> resultClass) throws SQLException {
        throw new SQLFeatureNotSupportedException("<T extends Result> T setResult(Class<T> resultClass)");
    }
}
